...
class BucketMockForElem extends _i1.GeneratedContract {
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> mockRegisterElement(
    _i1.EthereumAddress elemMock, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[14];
    assert(checkSignature(function, '696d7194'));
    final params = [elemMock];
    return write(
      credentials,
      transaction,
      function,
